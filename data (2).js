...
// ---------------------------------------------------------------------
// Deja esto en "null" mientras no tengas un proyecto de Firebase.
// En cuanto lo configures (ver README, sección "Sincronizar varios
// dispositivos"), pega aquí los 6 valores que te da Firebase. Al hacerlo,
// TODOS los que abran el link (estudiantes incluidos) se conectarán
// automáticamente a la misma base de datos, sin que nadie tenga que
// entrar a Configuración a poner nada. Las claves de una app web de
// Firebase no son secretas — la seguridad real vive en las "Reglas" que
// configuraste en Firestore — así que es seguro dejarlas aquí.
const FIREBASE_CONFIG = {
  apiKey: "AIzaSyBE0syLWm1L-ELJqwDQEA8mEY_NvdEToUM",
  authDomain: "cai-a26-e27.firebaseapp.com",
  projectId: "cai-a26-e27",
  storageBucket: "cai-a26-e27.firebasestorage.app",
  messagingSenderId: "192654650568",
  appId: "1:192654650568:web:a2f3c4873d68b6094009fd",
};
