...
function actividadFormHtml(a){
  ...
  return `
    ...
    <div class="fecha-block">
      <p class="muted-sm" style="margin:0 0 10px;"><strong>Programa la primera fecha de esta actividad.</strong> Después podrás agregar más fechas desde su tarjeta.</p>
      <div class="grid-2">
...
function bindActividadForm(existing){
  ...
  document.getElementById("afSave").addEventListener("click", () => {
    ...
    if (existing){
      ...
      const nueva = { id: uid("act"), activa:true, ...data };
